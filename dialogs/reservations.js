...
const library = new botbuilder.Library('reservations');
...
]).endConversationAction('cancelAction', 'Ok, annulation de la réservation.', {
    matches: /^annuler|^cancel$|^cancel.*order/i
});
